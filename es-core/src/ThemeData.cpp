...
{ "carousel", {
	...
	// ES-X: modo textlist para SystemView.
	// Mantiene la navegación real de SystemView, pero dibuja filas y selector
	// con una apariencia equivalente a TextListComponent.
	{ "displayMode", STRING },
	{ "fontPath", PATH },
	{ "fontSize", RESOLUTION_FLOAT },
	{ "primaryColor", COLOR },
	...
	// ES-X: selector de imagen y numeración para SystemView textlist.
	{ "selectorImagePath", PATH },
	{ "selectorImageTile", BOOLEAN },
	{ "showRowNumbers", BOOLEAN },
	...
	// ES-X: pulso de movimiento del sistema central seleccionado.
	{ "selectedLogoPulse", BOOLEAN },

	// ES-X: pulso de opacidad del logo central del carrusel
	{ "pulse", BOOLEAN },
	{ "pulseOpacityMin", FLOAT },
	{ "pulseOpacityMax", FLOAT },
	{ "pulseDuration", FLOAT },
